...
define('two/utils', [
    ...
    /**
     * Gera um nÃºmero aleatÃ³rio aproximado da base.
     *
     * @param {Number} base - NÃºmero base para o calculo.
     */
     ...
     *
     * @param {String} time - Tempo que serÃ¡ convertido (hh:mm:ss)
     */
    ...
    /**
     * Emite notificaÃ§Ã£o nativa do jogo.
     *
    ...
    /**
     * ValidaÃ§Ã£o de horario e data de envio. Exmplo: 23:59:00:999 30/12/2016
     *
    ...
    /**
     * Inverte a posiÃ§Ã£o do dia com o mÃªs.
     */
    ...
    /**
     * Obtem a diferenÃ§a entre o timezone local e do servidor.
     *
     * @type {Number}
     */
     ...
     * @param {Object} units - Exercito usado no ataque como referÃªncia
...
define('two/language', [
    ...
    "en_us": {
        ...
        "farm_overflow": {
            ...
            "multiple_attacks_interval": "Interval between attacks in the same target (minutes)",
    ...
    "de_de": {
        "about": {
            ...
            "issues_suggestions": "Probleme/VorschÃ¤ge",
            "translations": "Ãœbersetzung"
        },
        "attack_view": {
            "filter_types": "Typen",
            "filter_show_attacks_tooltip": "Zeige Angriffe",
            "filter_show_supports_tooltip": "Zeige UnterstÃ¼tzungen",
            ...
            "commands_copy_backtime_tooltip": "Kopiere Datum der RÃ¼ckkehr.",
        ...
        "builder_queue": {
            ...
            "settings_village_groups": "Ausbau von DÃ¶rfern mit den Gruppen",
            "settings_building_sequence": "Reihenfolge",
            "settings_building_sequence_final": "Finale GebÃ¤udestufen",
            "settings_priorize_farm": "Bevorzuge volle Farmen",
            "settings_saved": "Einstellungen gespeichert!",
            "logs_no_builds": "Kein Ausbau gestartet",
            "logs_clear": "Protokoll lÃ¶schen",
            "sequences": "Sequenzen",
            "sequences_move_up": "Bewege nach oben",
            "sequences_move_down": "Bewege nach unten",
            "sequences_add_building": "GebÃ¤udestufe hinzufÃ¼gen",
            "sequences_select_edit": "Sequenz zum Ã„ndern wÃ¤hlen",
            "sequences_edit_sequence": "Sequenz Ã¤ndern",
            "select_group": "Gruppe wÃ¤hlen",
            "add_building_success": "%d wurde auf Platz %d hinzugefÃ¼gt",
            "add_building_limit_exceeded": "%d hat die HÃ¶chststufe erreicht (%d)",
            "position": "Platz",
            "remove_building": "Entferne GebÃ¤udestufe aus der Sequenz",
            "clone": "Kopieren",
            "remove_sequence": "Remove selected sequence",
            ...
            "error_sequence_invalid": "Manche Werte dieser Sequenz sind ungÃ¼ltig.",
            "logs_cleared": "Protokoll gelÃ¶scht.",
        ...
        "builder_queue_add_building_modal": {
            "title": "Neue GebÃ¤udestufe hinzufÃ¼gen"
        },
        "builder_queue_name_sequence_modal": {
        ...
        "builder_queue_remove_sequence_modal": {
            ...
            "text": "MÃ¶chtest Du diese Sequenz wirklich entfernen? Wenn diese Sequenz aktiv ist, wird eine andere gewÃ¤hlt und die automatische BauschleifenbefÃ¼llung gestoppt."
        },
        "command_queue": {
            ...
            "queue_filters": "Commands filter",
            "filters_selected_village": "Zeige nur Befehle bezÃ¼glich des aktuellen Dorfs",
            "filters_barbarian_target": "Zeige nur Befehle mit BarbarendÃ¶rfer als Ziel",
            "filters_attack": "Zeige Angriffe",
            "filters_support": "Zeige UnterstÃ¼tzungen",
            ...
            "error_origin": "Startkoordinaten ungÃ¼ltig!",
            "error_target": "Zielkoordinaten ungÃ¼ltig!",
            "error_no_units": "Keine Einheiten ausgewÃ¤hlt!",
            "error_invalid_date": "UngÃ¼ltiges Datum",
            "error_already_sent_attack": "This attack should have already left",
            "error_already_sent_support": "This support should have already left",
            "error_already_sent_relocate": "This relocate should have already left",
            "error_relocate_disabled": "Relocate is not enabled in this world.",
            "error_no_map_selected_village": "Kein Dorf auf der Karte ausgewÃ¤hlt.",
            "error_remove_error": "Fehler beim Entfernen des Befehls.",
            "tab_add": "Befehl hinzufÃ¼gen",
            "tab_waiting": "Befehle in Warteschleife",
            "tab_logs": "Befehlsprotokoll"
        },
        "farm_overflow": {
            "open_report": "Bericht Ã¶ffnen",
            ...
            "status_no_units": "Keine verfÃ¼gbaren Einheiten",
            "status_abandoned_conquered": "Keine vefÃ¼gbaren Einheiten",
            "status_protected_village": "Ziel ist geschÃ¼tzt",
            "status_busy_target": "Ziel wird angegriffen",
            "status_no_targets": "Keine verfÃ¼gbaren Ziele",
            ...
            "included_targets": "HinzugefÃ¼gte Ziele",
            "no_included_targets": "Nichts hinzugefÃ¼gt",
            "farmer_villages": "FarmdÃ¶rfer",
            "no_farmer_villages": "Keine FarmdÃ¶rfer",
            "last_status": "Letzter Status",
            "attacking": "Im Angriff.",
            "paused": "Angehalten.",
            "command_limit": "Das Befehlslimit ist erreicht, bitte warte auf die RÃ¼ckkehr einiger Trupps.",
            "last_attack": "Letzter Angriff",
            "village_switch": "Wechsle zu Dorf",
            "no_preset": "Keine Vorlage verfÃ¼gbar.",
            "no_selected_village": "Keine DÃ¶rfer verfÃ¼gbar.",
            "no_units": "Keine Einheiten im Dorf, wartet auf die RÃ¼ckkehr von Trupps.",
            "no_units_no_commands": "Kein Dorf hat Einheiten oder zurÃ¼ckkehrende Befehle.",
            "no_villages": "Keine DÃ¶rfer verfÃ¼gbar, warte auf RÃ¼ckkehr von Befehlen.",
            "preset_first": "WÃ¤hle zuerst eine Vorlage!",
            "selected_village": "AusgewÃ¤hltes Dorf",
            "loading_targets": "Ziele werden geladen...",
            "checking_targets": "Ziele werden geprÃ¼ft...",
            "restarting_commands": "Befehle werden neu gestartet...",
            "ignored_village": "zur Ignorierliste hinzugefÃ¼gt",
            "included_village": "zur Eingeschlossenen-Liste hinzugefÃ¼gt",
            "ignored_village_removed": "aus der Ignorier-Liste entfernt",
            "included_village_removed": "aus der Eingeschlossenen-Liste entfernt",
            "priority_target": "zur PrioritÃ¤tenliste hinzugefÃ¼gt.",
            "analyse_targets": "Ziele werden analysiert.",
            "step_cycle_restart": "Befehlszyklus wird neu gestartet..",
            "step_cycle_end": "Dorfliste abgearbeitet, warte auf den nÃ¤chsten Durchlauf.",
            "step_cycle_end_no_villages": "Keine DÃ¶rfer verfÃ¼gbar um den Durchgang zu starten.",
            "step_cycle_next": "Dorfliste abgearbeitet, nÃ¤chster Durchgang: %d.",
            "step_cycle_next_no_villages": "Kein Dorf verfÃ¼gbar um den Durchgang zu starten, nÃ¤chster Durchgang: %d.",
            ...
            "group_only": "Greife nur aus DÃ¶rfern dieser Gruppen an",
            ...
            "target_multiple_farmers": "Erlaube Angriffe aus mehreren DÃ¶rfern pro Ziel",
            "farmer_cycle_interval": "Intervall zwischen Farmzyklen (in Min.)",
            "ignore_on_loss": "Ignoriere DÃ¶rfer, die Truppenverluste verursachen",
            "ignore_full_storage": "DÃ¶rfer mit vollen Speichern Ã¼berspringen",
            ...
            "logs_limit": "Max. Anzahl an Protokoll-EintrÃ¤gen",
            ...
            "event_ignored_village": "Ignorierte DÃ¶rfer protokollieren",
            "settings_saved": "Einstellungen gespeichert!",
            "misc": "Weitere Einstellungen",
            "attack": "angreifen",
            "no_logs": "Keine Angriffe protokolliert",
            "clear_logs": "Protokoll lÃ¶schen",
            "reseted_logs": "Protokoll wurde zurÃ¼ckgesetzt.",
            "date_added": "Datum hinzugefÃ¼gt",
            "multiple_attacks_interval": "Interval between attacks in the same target (minutes)",
            "next_cycle_in": "Next cycle starts in",
            "target_limit_per_village": "Limit of targets per village"
        },
        "minimap": {
            ...
            "highlight_add_success": "Farboption hinzugefÃ¼gt",
            "highlight_add_error": "WÃ¤hle zuerst eine Farboption",
            "highlight_update_success": "Farboptionen aktualisiert",
            "highlight_remove_success": "Farboption entfernt",
            "highlight_villages": "DÃ¶rfer",
            "highlight_players": "Spieler",
            "highlight_tribes": "StÃ¤mme",
            "highlight_add_error_exists": "Farboption existiert bereits!",
            "highlight_add_error_no_entry": "WÃ¤hle zuerst einen Spieler/Stamm aus!",
            "highlight_add_error_invalid_color": "UngÃ¼ltige Farbe!",
            "village": "Dorf",
            "player": "Spieler",
            "tribe": "Stamm",
            "color": "Wert (Hex)",
            "tooltip_pick_color": "Eine Farbe auswÃ¤hlen",
            "misc": "Weitere Einstellungen",
            ...
            "settings_show_continent_demarcations": "Show continent demarcations",
            "settings_show_province_demarcations": "Show province demarcations",
            "settings_show_barbarians": "Zeige BarbarendÃ¶rfer",
            "settings_show_ghost_villages": "Nicht geladene DÃ¶rfer anzeigen",
            "settings_show_only_custom_highlights": "Nur benutzerdefinierte Farboptionen anzeigen",
            "settings_highlight_own": "Eigene DÃ¶rfer automatisch hervorheben",
            "settings_highlight_selected": "AusgewÃ¤hltes Dorf automatisch hervorheben",
            ...
            "settings_colors_continent": "KÃ¶nigreichsgrenze",
            "settings_colors_quick_highlight": "Schnelles Hervorheben",
            "settings_colors_tribe": "Eigener Stamm",
            "settings_colors_player": "Eigene DÃ¶rfer",
            "settings_colors_selected": "AusgewÃ¤hltes Dorf",
            "settings_colors_ghost": "Nicht geladene DÃ¶rfer",
            "settings_colors_ally": "BÃ¼ndnis",
            "settings_colors_pna": "NAP",
            "settings_colors_enemy": "Feind",
            "settings_colors_other": "Sonstige",
            "settings_colors_barbarian": "Barbaren",
            "settings_colors_view_reference": "View reference",
            "settings_reset": "Einstellungen wurden zurÃ¼ckgesetzt",
            ...
            "reset_confirm_title": "Einstellungen zurÃ¼ck setzen",
            "reset_confirm_text": "Alle Einstellungen werden auf Standardeinstellungen zurÃ¼ckgesetzt.",
            "reset_confirm_highlights_text": "Es werden auch alle Farboptionen gelÃ¶scht.",
            "default_village_colors_info": "Color of default villages like abandoned, allies, own tribe, etc. Are altered by the own game's settings panel."
        },
        "common": {
            "start": "Start",
    ...
    "pl_pl": {
        "about": {
            "contact": "Kontakt",
            "email": "E-mail",
            "links": "Linki projektÃ³w",
            "source_code": "Kod ÅºrÃ³dÅ‚owy",
            "issues_suggestions": "BÅ‚Ä™dy/sugestie",
            "translations": "TÅ‚umaczenia"
        },
        "attack_view": {
            "filter_types": "Rodzaj",
            "filter_show_attacks_tooltip": "PokaÅ¼ ataki",
            "filter_show_supports_tooltip": "PokaÅ¼ wsparcia",
            "filter_show_relocations_tooltip": "PokaÅ¼ przeniesienia",
            "filter_incoming_units": "NadchodzÄ…ce jednostki",
            "commands_copy_arrival_tooltip": "Kopiuj czas dotarcia.",
            "commands_copy_backtime_tooltip": "Kopiuj czas powrotu do wioski ÅºrÃ³dÅ‚owej.",
            "commands_set_remove_tooltip": "Wstaw rozkaz wycofania wojsk przed dotarciem ataku do Kolejki rozkazÃ³w.",
            "command_type_tooltip": "Rodzaj",
            "slowest_unit_tooltip": "Najwolniejsza jednostka",
            "command_type": "Rodzaj",
            "slowest_unit": "Co?",
            "actions": "DostÄ™pne akcje",
            "no_incoming": "Brak nadchodzÄ…cych wojsk.",
            "copy": "Copy",
        ...
        "builder_queue": {
            ...
            "settings_building_sequence_final": "Finalne poziomy budynkÃ³w",
            "settings_priorize_farm": "Priorytet farmy, jeÅ¼eli brakuje prowiantu",
            "settings_saved": "Ustawienia zapisane!",
            "logs_no_builds": "Nie rozpoczÄ™to Å¼adnej rozbudowy",
            "logs_clear": "WyczyÅ›Ä‡ logi",
            "sequences": "Szablony",
            "sequences_move_up": "PrzesuÅ„ w gÃ³rÄ™",
            "sequences_move_down": "PrzesuÅ„ w dÃ³Å‚",
            ...
            "select_group": "Wybierz grupÄ™",
            "add_building_success": "%d dodany na pozycji %d",
            "add_building_limit_exceeded": "%d osiÄ…gnÄ…Å‚/eÅ‚a maksymalny poziom (%d)",
            "position": "Pozycja",
            "remove_building": "UsuÅ„ budynek z listy",
            "clone": "Klonuj",
            "remove_sequence": "Remove selected sequence",
            "name_sequence_min_lenght": "The sequence name must have at least 3 character.",
            "sequence_created": "Nowy szablon %d utworzony.",
            "sequence_updated": "Szablon %d zaktualizowany.",
            "sequence_removed": "Szablon %d usuniÄ™ty.",
            "error_sequence_exists": "Ten szablon juÅ¼ istnieje.",
            "error_sequence_no_exists": "Ta sekwencja nie istnieje.",
            "error_sequence_invalid": "NiektÃ³re z wartoÅ›ci szablonu sÄ… niepoprawne.",
            "logs_cleared": "Logi wyczyszczone.",
            "create_sequence": "UtwÃ³rz szablon",
        ...
        "builder_queue_remove_sequence_modal": {
            "title": "UsuÅ„ szablon",
            "text": "JesteÅ› pewny, Å¼e chcesz usunÄ…Ä‡ ten szablon? JeÅ›li ten szablon jest teraz aktywny, inny szablon zostanie wybrany i BuilderQueue zatrzyma siÄ™."
        },
        "command_queue": {
            "title": "CommandQueue",
            "attack": "Atak",
            ...
            "relocate": "przenieÅ›",
            "sent": "wysÅ‚any/e",
            "activated": "wÅ‚Ä…czony",
            "deactivated": "wyÅ‚Ä…czony",
            "expired": "przedawniony/e",
            "removed": "usuniÄ™ty/e",
            "added": "dodany/e",
            "general_clear": "Clear logs",
            "general_next_command": "NastÄ™pny rozkaz",
            "add_basics": "Podstawowe informacje",
            "add_origin": "Å¹rÃ³dÅ‚o",
            ...
            "add_current_date_plus": "ZwiÄ™ksz czas o 100 milisekund.",
            "add_current_date_minus": "Zmniejsz czas o 100 milisekund.",
            "add_travel_times": "Czas podrÃ³Å¼y jednostek",
            "add_date": "Czas/Data",
            "add_no_village": "Wybierz wioskÄ™...",
            "add_village_search": "ZnajdÅº wioskÄ™...",
            "add_clear": "wyczyÅ›Ä‡",
            "add_insert_preset": "Wybierz szablon",
            "queue_waiting": "Rozkazy",
            "queue_none_added": "Brak dodanych rozkazÃ³w.",
            "queue_sent": "Rozkazy wysÅ‚ane",
            "queue_none_sent": "Brak wysÅ‚anych rozkazÃ³w.",
            "queue_expired": "Przedawnione rozkazy",
            "queue_none_expired": "Brak przedawnionych rozkazÃ³w.",
            "queue_remove": "UsuÅ„ rozkaz z listy",
            "queue_filters": "Filtruj rozkazy",
            "filters_selected_village": "PokaÅ¼ tylko rozkazy z aktywnej wioski",
            "filters_barbarian_target": "PokaÅ¼ tylko rozkazy na wioski barbarzyÅ„skie",
            "filters_attack": "PokaÅ¼ ataki",
            "filters_support": "PokaÅ¼ wsparcia",
            "filters_relocate": "PokaÅ¼ przeniesienia",
            "filters_text_match": "Filtruj za pomocÄ… tekstu...",
            "command_out": "Czas wyjÅ›cia",
            "command_time_left": "PozostaÅ‚y czas",
            "command_arrive": "Czas dotarcia",
            "error_no_units_enough": "No units enough to send the command!",
            "error_not_own_village": "Wioska ÅºrÃ³dÅ‚owa nie naleÅ¼y do ciebie!",
            "error_origin": "NieprawidÅ‚owa wioska ÅºrÃ³dÅ‚owa!",
            "error_target": "NieprawidÅ‚owa wioska cel!",
            "error_no_units": "Nie wybrano jednostek!",
            "error_invalid_date": "NieprawidÅ‚owy Czas",
            "error_already_sent_attack": "This attack should have already left",
            "error_already_sent_support": "This support should have already left",
            "error_already_sent_relocate": "This relocate should have already left",
            "error_relocate_disabled": "Relocate is not enabled in this world.",
            "error_no_map_selected_village": "Nie zaznaczono wioski na mapie.",
            "error_remove_error": "BÅ‚Ä…d usuwania rozkazu.",
            "tab_add": "Dodaj rozkaz",
            "tab_waiting": "OczekujÄ…ce",
            "tab_logs": "Logi"
        },
        "farm_overflow": {
            "open_report": "OtwÃ³rz raport",
            "no_report": "Nie ma raportu",
            "reports": "Raporty",
            "date": "Data",
            "status_time_limit": "Cel jest zbyt daleko",
            "status_command_limit": "Limit poleceÅ„",
            "status_full_storage": "Magazyn jest peÅ‚en",
            "status_no_units": "Brak dostÄ™pnych jednostek",
            ...
            "status_no_targets": "Brak dostÄ™pnych celÃ³w",
            "status_target_cycle_end": "Cykl celÃ³w zakoÅ„czony",
            ...
            "attacking": "Atakuje.",
            "paused": "Zatrzymany.",
            "command_limit": "Limit 50 atakÃ³w osiÄ…gniÄ™ty, oczekiwanie na powrÃ³t wojsk.",
            "last_attack": "Ostatni atak",
            "village_switch": "PrzejÅ›cie do wioski",
            "no_preset": "Brak dostÄ™pnych szablonÃ³w.",
            "no_selected_village": "Brak dostÄ™pnych wiosek.",
            "no_units": "Brak dostÄ™pnych jednostek w wiosce, oczekiwanie na powrÃ³t wojsk.",
            "no_units_no_commands": "Brak jednostek w wioskach lub powracajÄ…cych wojsk.",
            "no_villages": "Brak dostÄ™pnych wiosek, oczekiwanie na powrÃ³t wojsk.",
            "preset_first": "Wybierz najpierw szablon!",
            "selected_village": "Wybrana wioska",
            "loading_targets": "Åadowanie celÃ³w...",
            "checking_targets": "Sprawdzanie celÃ³w...",
            "restarting_commands": "Restartowanie poleceÅ„...",
            "ignored_village": "dodany do listy pominiÄ™tych",
            "included_village": "dodany do listy zawartych",
            "ignored_village_removed": "usuniÄ™ty z listy ignorowanych",
            "included_village_removed": "usuniÄ™ty z listy zawartych",
            "priority_target": "dodany do priorytetowych.",
            "analyse_targets": "Analizowanie celÃ³w.",
            "step_cycle_restart": "Restartowanie cyklu poleceÅ„...",
            "step_cycle_end": "Lista wiosek zakoÅ„czona, oczekiwanie na nastÄ™pny cykl.",
            "step_cycle_end_no_villages": "Brak wiosek do rozpoczÄ™cia cyklu.",
            "step_cycle_next": "Lista wiosek siÄ™ skoÅ„czyÅ‚a, nastÄ™pny cykl: %d.",
            "step_cycle_next_no_villages": "Brak wioski do rozpoczÄ™cia cyklu, nastÄ™pny cykl: %d.",
            "full_storage": "Magazyn w wiosce jest peÅ‚ny",
            ...
            "attack_interval": "Przerwa miÄ™dzy atakami",
            "preserve_command_slots": "Rezerwuj sloty poleceÅ„",
            "target_single_attack": "ZezwÃ³l celom na jeden atak per wioska",
            "target_multiple_farmers": "ZezwÃ³l celom otrzymywaÄ‡ ataki z kilku wiosek",
            "farmer_cycle_interval": "Przerwa pomiÄ™dzy cyklami farmienia (minut)",
            "ignore_on_loss": "Pomijaj cele jeÅ›li straty",
            "ignore_full_storage": "Pomijaj wioski jeÅ›li magazyn peÅ‚ny",
            "step_cycle_header": "Cykl Farmienia",
            "step_cycle": "WÅ‚Ä…cz Cykl farmienia",
            "step_cycle_notifs": "Powiadomienia",
            "target_filters": "Filtry celÃ³w",
            "min_distance": "Minimalna odlegÅ‚oÅ›Ä‡",
            "max_distance": "Maksymalna odlegÅ‚oÅ›Ä‡",
            "min_points": "Minimalna liczba punktÃ³w",
            "max_points": "Maksymalna liczba punktÃ³w",
            "max_travel_time": "Maksymalny czas podrÃ³Å¼y (minuty)",
            "logs_limit": "Maksymalna iloÅ›Ä‡ wpisÃ³w logÃ³w",
            "event_attack": "Logi atakÃ³w",
            "event_village_change": "Logi zmiany wiosek",
            "event_priority_add": "Logi celÃ³w priorytetowych",
            "event_ignored_village": "Logi pominiÄ™tych wiosek",
            "settings_saved": "Ustawienia zapisane!",
            "misc": "RÃ³Å¼ne",
            "attack": "atakuje",
            "no_logs": "Brak zarejestrowanych logÃ³w",
            "clear_logs": "WyczyÅ›Ä‡ logi",
            "reseted_logs": "Zarejestrowane logi zostaÅ‚y wyczyszczone.",
        ...
        "minimap": {
            "minimap": "Minimap",
            "highlights": "PodÅ›wietlenie",
            "add": "Dodaj podÅ›wietlenie",
            "remove": "UsuÅ„ podÅ›wietlenie",
            "very_small": "Very small",
            "small": "Small",
            "big": "Big",
            "very_big": "Very big",
            "placeholder_search": "Szukaj gracz/plemiÄ™",
            "highlight_add_success": "PodÅ›wietlenie dodane",
            "highlight_add_error": "Najpierw sprecyzuj podÅ›wietlenie",
            "highlight_update_success": "PodÅ›wietlenie zaktualizowane",
            "highlight_remove_success": "PodÅ›wietlenie usuniÄ™te",
            "highlight_villages": "Wioski",
            "highlight_players": "Gracze",
            "highlight_tribes": "Plemiona",
            "highlight_add_error_exists": "PodÅ›wietlenie juÅ¼ istnieje!",
            "highlight_add_error_no_entry": "Najpierw wybierz gracza/plemiÄ™!",
            "highlight_add_error_invalid_color": "NieprawidÅ‚owy kolor!",
            "village": "Wioska",
            "player": "Gracz",
            "tribe": "PlemiÄ™",
            "color": "Kolor (Hex)",
            "tooltip_pick_color": "Wybierz kolor",
            "misc": "PozostaÅ‚e ustawienia",
            "colors_misc": "RÃ³Å¼ne kolory",
            "colors_diplomacy": "Dyplomacja - kolory",
            "settings_saved": "Ustawienia zapisane!",
            "settings_map_size": "Map size",
            "settings_right_click_action": "PPM aby wykonaÄ‡ dziaÅ‚anie na wiosce",
            "highlight_village": "PodÅ›wietl wioskÄ™",
            "highlight_player": "PodÅ›wietl gracza",
            "highlight_tribe": "PodÅ›wietl plemie",
            "settings_show_floating_minimap": "PokaÅ¼ ruchomÄ… mapÄ™",
            "settings_show_view_reference": "Show view reference",
            "settings_show_continent_demarcations": "Show continent demarcations",
            "settings_show_province_demarcations": "Show province demarcations",
            "settings_show_barbarians": "PokaÅ¼ wioski barbarzyÅ„skie",
            "settings_show_ghost_villages": "PokaÅ¼ niezaÅ‚adowane wioski",
            "settings_show_only_custom_highlights": "PokaÅ¼ tylko wÅ‚asne podÅ›wietlenia",
            "settings_highlight_own": "PodÅ›wietl wÅ‚asne wioski",
            "settings_highlight_selected": "PodÅ›wietl wybranÄ… wioskÄ™",
            "settings_highlight_diplomacy": "Automatycznie podÅ›wietl plemiennÄ… dyplomacjÄ™",
            "settings_colors_background": "TÅ‚o minimapy",
            "settings_colors_province": "Granica prowincji",
            "settings_colors_continent": "Granica kontynentu",
            "settings_colors_quick_highlight": "Szybkie podÅ›wietlenie",
            "settings_colors_tribe": "WÅ‚asne plemie",
            "settings_colors_player": "WÅ‚asne wioski",
            "settings_colors_selected": "Wybrana wioska",
            "settings_colors_ghost": "NiezaÅ‚adowana wioska",
            "settings_colors_ally": "Sojusznik",
            "settings_colors_pna": "PON",
            "settings_colors_enemy": "WrÃ³g",
            "settings_colors_other": "PozostaÅ‚e wioski graczy",
            "settings_colors_barbarian": "Wioski barbarzyÅ„skie",
            "settings_colors_view_reference": "View reference",
            ...
            "tooltip_tribe": "PlemiÄ™",
            "tooltip_tribe_points": "Punkty plemienia",
            "tooltip_province": "Prowincja",
            "no_highlights": "Brak utworzonych podÅ›wietleÅ„",
            "reset_confirm_title": "Resetuj ustawienia",
            "reset_confirm_text": "Wszystkie ustawienia zostanÄ… przywrÃ³cone do domyÅ›lnych.",
            "reset_confirm_highlights_text": "Jak rÃ³wnieÅ¼ wszystkie podÅ›wietlenia zostanÄ… usuniÄ™te.",
            "default_village_colors_info": "Color of default villages like abandoned, allies, own tribe, etc. Are altered by the own game's settings panel."
        },
        "common": {
            "start": "Start",
            ...
            "player": "Gracz",
            "players": "Gracze",
            "next_features": "NastÄ™pne funkcje",
            "misc": "RÃ³Å¼ne",
            "colors": "Kolory",
            "reset": "Resetuj",
            "here": "tutaj",
            "disabled": "â€” WyÅ‚Ä…czony â€”",
            "cancel": "Anuluj",
            "actions": "Akcje",
            "remove": "UsuÅ„",
    ...
    "pt_br": {
        "about": {
            ...
            "issues_suggestions": "IdÃ©ias/SugestÃµes",
        ...
        "attack_view": {
            ...
            "filter_show_relocations_tooltip": "Mostrar transferÃªncias",
        ...
        "auto_collector": {
            "description": "Coletor automÃ¡tico para DepÃ³sito de Recursos/Segunda Aldeia.",
            "activated": "Coletor AutomÃ¡tico ativado",
            "deactivated": "Coletor AutomÃ¡tico desativado"
        },
        "builder_queue": {
            ...
            "settings_building_sequence": "SequÃªncia de construÃ§Ãµes",
            "settings_building_sequence_final": "NÃ­vel final das construÃ§Ãµes",
            "settings_priorize_farm": "Priorizar fazenda se estiver lotada",
            "settings_saved": "ConfiguraÃ§Ãµes salvas!",
            "logs_no_builds": "Nenhuma construÃ§Ã£o iniciada",
            "logs_clear": "Limpar registros",
            "sequences": "SequÃªncias",
            "sequences_move_up": "Mover acima",
            "sequences_move_down": "Mover abaixo",
            "sequences_add_building": "Adicionar edifÃ­cio",
            "sequences_select_edit": "Selecione uma sequÃªncia para editar",
            "sequences_edit_sequence": "Editar sequÃªncia",
            "select_group": "Selecione um grupo",
            "add_building_success": "%d foi adicionado Ã  posiÃ§Ã£o %d",
            "add_building_limit_exceeded": "%d chegou ao nÃ­vel mÃ¡ximo (%d)",
            "position": "PosiÃ§Ã£o",
            "remove_building": "Remover edifÃ­cio da lista",
            "clone": "Clonar",
            "remove_sequence": "Remover sequÃªncia selecionada",
            "name_sequence_min_lenght": "O nome da sequÃªncia deve ter pelo menos 3 caracteres.",
            "sequence_created": "Nova sequÃªncia %d criada.",
            "sequence_updated": "SequÃªncia %d atualizada.",
            "sequence_removed": "SequÃªncia %d removida.",
            "error_sequence_exists": "Esta sequÃªncia jÃ¡ existe.",
            "error_sequence_no_exists": "Essa sequÃªncia nÃ£o existe.",
            "error_sequence_invalid": "Algum valor da sequÃªncia Ã© invÃ¡lido.",
            "logs_cleared": "Registro limpo.",
            "create_sequence": "Criar uma sequÃªncia",
            ...
            "discard_changes_title": "SequÃªncia nÃ£o salva",
            "discard_changes_text": "A sequÃªncia selecionada tem alteraÃ§Ãµes nÃ£o salvas. Tem certeza que deseja descartar  as alteraÃ§Ãµes?",
            "clone_warn_changed_sequence_title": "SequÃªncia alterada",
            "clone_warn_changed_sequence_text": "A sequÃªncia que vocÃª estÃ¡ tentando clonar foi alterada. Se aceitar, a versÃ£o antiga serÃ¡ clonada.",
            "clone_sequence": "Clonar sequÃªncia selecionada",
            "amount": "Quantidade",
            "empty_sequence": "SequÃªncia vazia"
        },
        "builder_queue_add_building_modal": {
            "title": "Adicionar novo edifÃ­cio"
        },
        "builder_queue_name_sequence_modal": {
            "title": "Nomear sequÃªncia"
        },
        "builder_queue_remove_sequence_modal": {
            "title": "Remover sequÃªncia",
            "text": "Tem certeza que deseja remover esta sequÃªncia? Se esta sequÃªncia estiver ativa, outra serÃ¡ selecionada e o BuilderQueue serÃ¡ parado."
        },
        "command_queue": {
            "title": "CommandQueue",
            "attack": "Ataque",
            "support": "Apoio",
            "relocate": "TransferÃªncia",
            "sent": "enviado",
            "activated": "ativado",
            ...
            "general_next_command": "PrÃ³ximo comando",
            "add_basics": "InformaÃ§Ãµes bÃ¡sicas",
            ...
            "add_insert_preset": "Inserir predefiniÃ§Ã£o",
            ...
            "filters_barbarian_target": "Mostrar apenas comandos com aldeias bÃ¡rbaras como alvo",
            "filters_attack": "Mostrar ataques",
            "filters_support": "Mostrar apoios",
            "filters_relocate": "Mostrar transferÃªncias",
            "filters_text_match": "Filtrar por texto...",
            "command_out": "SaÃ­da na data",
            ...
            "error_not_own_village": "A aldeia de origem nÃ£o pertence a vocÃª!",
            "error_origin": "Aldeia de origem invÃ¡lida!",
            "error_target": "Aldeia alvo invÃ¡lida!",
            "error_no_units": "Nenhuma unidade especificada!",
            "error_invalid_date": "Data invÃ¡lida",
            "error_already_sent_attack": "Esse ataque jÃ¡ deveria ter saÃ­do",
            "error_already_sent_support": "Esse apoio jÃ¡ deveria ter saÃ­do",
            "error_already_sent_relocate": "Essa transferÃªncia jÃ¡ deveria ter saÃ­do",
            "error_relocate_disabled": "TransferÃªncia nÃ£o estÃ¡ ativa nesse mundo.",
        ...
        "farm_overflow": {
            "open_report": "Abrir relatÃ³rio",
            "no_report": "Sem relatÃ³rio",
            "reports": "RelatÃ³rios",
            "date": "Data",
            "status_time_limit": "Alvo muito longe",
            "status_command_limit": "Limite de comandos",
            "status_full_storage": "ArmazÃ©m lotado",
            "status_no_units": "Sem tropas disponÃ­veis",
            "status_abandoned_conquered": "Abandonada conquistada",
            "status_protected_village": "Alvo estÃ¡ protegido",
            "status_busy_target": "Alvo jÃ¡ sob ataque",
            "status_no_targets": "Nenhum alvo disponÃ­vel",
            "status_target_cycle_end": "Cicle de alvos acabou",
            "status_not_allowed_points": "Pontos do alvo nÃ£o permitido",
            ...
            "included_targets": "Alvos incluÃ­dos",
            "no_included_targets": "Nada incluÃ­do",
            "farmer_villages": "Aldeias Farm",
            "no_farmer_villages": "Nenhuma aldeia farm disponÃ­vel",
            "last_status": "Ãšltimo Status",
            "attacking": "Atacando.",
            "paused": "Pausado.",
            "command_limit": "Limite de 50 ataques atingido, aguardando retorno.",
            "last_attack": "Ãšltimo ataque",
            "village_switch": "Alternando para a aldeia",
            "no_preset": "Nenhuma predefiniÃ§Ã£o disponÃ­vel.",
            "no_selected_village": "Nenhuma aldeia disponÃ­vel.",
            ...
            "no_villages": "Nenhuma aldeia disponÃ­vel, aguardando ataques retornarem.",
            "preset_first": "Configure uma predefiniÃ§Ã£o primeiro!",
            ...
            "included_village": "adicionado Ã  lista de aldeias incluÃ­das",
            "ignored_village_removed": "removida da lista de aldeias ignoradas",
            "included_village_removed": "removida da lista de aldeias incluÃ­das",
            ...
            "step_cycle_end": "A lista de aldeias acabou, esperando prÃ³xima execuÃ§Ã£o.",
            "step_cycle_end_no_villages": "Nenhuma aldeia disponÃ­vel para iniciar o ciclo.",
            "step_cycle_next": "A lista de aldeias acabou, prÃ³ximo ciclo: %d.",
            "step_cycle_next_no_villages": "Nenhuma aldeia disponÃ­vel para iniciar o ciclo, prÃ³ximo ciclo: %d.",
            "full_storage": "O armazÃ©m da aldeia estÃ¡ cheio.",
            "farm_stopped": "FarmOverflow parado.",
            "farm_started": "FarmOverflow iniciado.",
            "groups_presets": "Grupos & predefiniÃ§Ãµes",
            "presets": "Atacar com as predefiniÃ§Ãµes",
            ...
            "preserve_command_slots": "NÃºmero de comandos a se preservar",
            "target_single_attack": "Permitir que alvos recebam apenas um ataque por aldeia",
            "target_multiple_farmers": "Permitir que alvos recebam ataques de mÃºltiplas aldeias",
            "farmer_cycle_interval": "Intervalo entre ciclos de farm (minutos)",
            "ignore_on_loss": "Ignorar alvos que causarem perdas",
            "ignore_full_storage": "Ignorar aldeias com armazÃ©m lotado",
            "step_cycle_header": "ConfiguraÃ§Ãµes de Ciclos",
            "step_cycle": "Ativar Ciclo",
            "step_cycle_notifs": "NotificaÃ§Ãµes de ciclos",
            "target_filters": "Filtro de Alvos",
            "min_distance": "DistÃ¢ncia mÃ­nima",
            "max_distance": "DistÃ¢ncia mÃ¡xima",
            "min_points": "PontuaÃ§Ã£o mÃ­nima",
            "max_points": "PontuaÃ§Ã£o mÃ¡xima",
            "max_travel_time": "Tempo mÃ¡ximo de viagem (minutos)",
            "logs_limit": "Quantidade mÃ¡xima de registros",
            ...
            "next_cycle_in": "PrÃ³ximo ciclo comeÃ§a em",
            "target_limit_per_village": "Limite de alvos por aldeia"
        },
        "minimap": {
            "minimap": "Minimapa",
            "highlights": "MarcaÃ§Ãµes",
            "add": "Adicionar marcaÃ§Ã£o",
            "remove": "Remover marcaÃ§Ã£o",
            "very_small": "Muito pequeno",
            "small": "Pequeno",
            "big": "Grande",
            "very_big": "Muito grande",
            "placeholder_search": "Procurar jogador/tribo",
            "highlight_add_success": "MarcaÃ§Ã£o adicionada",
            "highlight_add_error": "Especifique uma marcaÃ§Ã£o primeiro",
            "highlight_update_success": "MarcaÃ§Ã£o atualizada",
            "highlight_remove_success": "MarcaÃ§Ã£o removida",
            "highlight_villages": "Aldeias",
            "highlight_players": "Jogadores",
            "highlight_tribes": "Tribos",
            "highlight_add_error_exists": "MarcaÃ§Ã£o jÃ¡ existe!",
            "highlight_add_error_no_entry": "Selecione uma jogador/tribo primeiro!",
            "highlight_add_error_invalid_color": "Cor invÃ¡lida!",
            "village": "Aldeia",
            "player": "Jogador",
            "tribe": "Tribo",
            "color": "Cor (Hex)",
            "tooltip_pick_color": "Selecione uma cor",
            "misc": "ConfiguraÃ§Ãµes diversas",
            "colors_misc": "Cores diversas",
            "colors_diplomacy": "Cores da diplomacia",
            "settings_saved": "ConfiguraÃ§Ãµes salvas!",
            "settings_map_size": "Tamanho do mapa",
            "settings_right_click_action": "AÃ§Ã£o de clique direito na aldeia",
            ...
            "settings_show_view_reference": "Mostrar referÃªncia de localizaÃ§Ã£o",
            "settings_show_continent_demarcations": "Mostrar demarcaÃ§Ãµes dos continentes",
            "settings_show_province_demarcations": "Mostrar demarcaÃ§Ãµes das provÃ­ncias",
            "settings_show_barbarians": "Mostrar aldeias bÃ¡rbaras",
            "settings_show_ghost_villages": "Mostrar aldeias nÃ£o carregadas",
            "settings_show_only_custom_highlights": "Mostrar apenas marcaÃ§Ãµes manuais",
            "settings_highlight_own": "Marcar prÃ³prias aldeias",
            "settings_highlight_selected": "Marcar aldeia selecionada",
            "settings_highlight_diplomacy": "MarcaÃ§Ã£o automÃ¡tica baseado na diplomacia",
            "settings_colors_background": "Fundo do minimapa",
            "settings_colors_province": "DemarcaÃ§Ã£o da provincia",
            "settings_colors_continent": "DemarcaÃ§Ã£o do continente",
            "settings_colors_quick_highlight": "MarcaÃ§Ã£o rÃ¡pida",
            "settings_colors_tribe": "PrÃ³pria tribo",
            "settings_colors_player": "Aldeias prÃ³prias",
            "settings_colors_selected": "Aldeia selecionada",
            "settings_colors_ghost": "Aldeias nÃ£o carregadas",
            "settings_colors_ally": "Aliados",
            "settings_colors_pna": "PNA",
            "settings_colors_enemy": "Inimigos",
            "settings_colors_other": "Outros",
            "settings_colors_barbarian": "Aldeias BÃ¡rbaras",
            "settings_colors_view_reference": "ReferÃªncia de localizaÃ§Ã£o",
            "settings_reset": "ConfiguraÃ§Ãµes resetadas",
            ...
            "tooltip_province": "Nome da provÃ­ncia",
            "no_highlights": "Nenhuma marcaÃ§Ã£o criada",
            "reset_confirm_title": "Resetar configuraÃ§Ãµes",
            "reset_confirm_text": "Todas as configuraÃ§Ãµes serÃ£o resetas para as configuraÃ§Ãµes padrÃµes.",
            "reset_confirm_highlights_text": "Todas marcaÃ§Ãµes tambÃ©m serÃ£o deletadas",
            "default_village_colors_info": "Cores de aldeias padrÃµes como abandonadas, aliados, prÃ³pria tribo, etc. SÃ£o alteradas pelo painel de configuraÃ§Ãµes do prÃ³prio jogo."
        },
        "common": {
            "start": "Iniciar",
            "started": "Iniciado",
            ...
            "player": "Jogador",
            "players": "Jogadores",
            "next_features": "PrÃ³ximas funcionalidades",
            "misc": "Diversos",
            "colors": "Cores",
            "reset": "Resetar",
            "here": "aqui",
            "disabled": "â€” Desativado â€”",
            "cancel": "Cancelar",
            "actions": "AÃ§Ãµes",
            "remove": "Remover",
            ...
            "settings_saved": "ConfiguraÃ§Ãµes salvas",
            "discard": "Descartar",
            "new_version": "TWOverflow atualizado para a versÃ£o %d",
            "check_changes": "Clique aqui para ver as alteraÃ§Ãµes",
            "firefox_shill": "Se vocÃª quiser que o script funcione de fundo corretamente, use Firefox ao invÃ©s de navegadores baseado no Chrome."
        }
    },
    "ru_ru": {
        "about": {
        ...
        "attack_view": {
            "filter_types": "Ð¢Ð¸Ð¿Ñ‹",
            "filter_show_attacks_tooltip": "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð°Ñ‚Ð°ÐºÐ¸",
            "filter_show_supports_tooltip": "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð¿Ð¾Ð´ÐºÑ€ÐµÐ¿Ð»ÐµÐ½Ð¸Ñ",
            "filter_show_relocations_tooltip": "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð¿ÐµÑ€ÐµÐ¼ÐµÑ‰ÐµÐ½Ð¸Ñ",
            "filter_incoming_units": "Ð’Ñ…Ð¾Ð´ÑÑ‰Ð¸Ðµ Ð²Ð¾Ð¹ÑÐºÐ°",
            "commands_copy_arrival_tooltip": "ÐšÐ¾Ð¿Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð´Ð°Ñ‚Ñƒ Ð¿Ñ€Ð¸Ð±Ñ‹Ñ‚Ð¸Ñ.",
            "commands_copy_backtime_tooltip": "ÐšÐ¾Ð¿Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð´Ð°Ñ‚Ñƒ Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‰ÐµÐ½Ð¸Ñ.",
            "commands_set_remove_tooltip": "Set a CommandQueue to remove all troops before the attack hit.",
            "command_type_tooltip": "Ð¢Ð¸Ð¿ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñ‹",
            "slowest_unit_tooltip": "Ð¡Ð°Ð¼Ñ‹Ð¹ Ð¼ÐµÐ´Ð»ÐµÐ½Ð½Ñ‹Ð¹ Ð²Ð¾Ð¸Ð½",
            "command_type": "CT",
            "slowest_unit": "SU",
            "actions": "Ð”ÐµÐ¹ÑÑ‚Ð²Ð¸Ñ",
            "no_incoming": "ÐÐµÑ‚ Ð²Ñ…Ð¾Ð´ÑÑ‰Ð¸Ñ… ÐºÐ¾Ð¼Ð°Ð½Ð´.",
            "copy": "ÐšÐ¾Ð¿Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ",
            "current_only_tooltip": "Ð¢Ð¾Ð»ÑŒÐºÐ¾ Ñ‚ÐµÐºÑƒÑ‰Ð°Ñ Ð´ÐµÑ€ÐµÐ²Ð½Ñ"
        },
        "auto_collector": {
            "description": "ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ¸Ð¹ ÑÐ±Ð¾Ñ€ Ð½Ð°Ð³Ñ€Ð°Ð´ Ñ Ð´ÐµÐ¿Ð¾Ð·Ð¸Ñ‚Ð°/Ð²Ñ‚Ð¾Ñ€Ð¾Ð¹ Ð´ÐµÑ€ÐµÐ²Ð½Ð¸.",
            "activated": "ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ¸Ð¹ ÑÐ±Ð¾Ñ€ Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½",
            "deactivated": "ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ¸Ð¹ ÑÐ±Ð¾Ñ€ Ð²Ñ‹ÐºÐ»ÑŽÑ‡ÐµÐ½"
        },
        "builder_queue": {
            "started": "ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ¾Ðµ ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÐµÐ»ÑŒÑÑ‚Ð²Ð¾ Ð°ÐºÑ‚Ð¸Ð²Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¾",
            "stopped": "ÐÐ²Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¸Ñ‡ÐµÑÐºÐ¾Ðµ ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÐµÐ»ÑŒÑÑ‚Ð²Ð¾ Ð´ÐµÐ°ÐºÑ‚Ð¸Ð²Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¾",
            "settings": "ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸",
            "settings_village_groups": "Ð¡Ñ‚Ñ€Ð¾Ð¸Ñ‚ÑŒ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ð² Ð´ÐµÑ€ÐµÐ²Ð½ÑÑ… Ñ Ð³Ñ€ÑƒÐ¿Ð¿Ð¾Ð¹",
            "settings_building_sequence": "ÐžÑ‡ÐµÑ€ÐµÐ´ÑŒ ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÐµÐ»ÑŒÑÑ‚Ð²Ð°",
            "settings_building_sequence_final": "ÐœÐ°ÐºÑÐ¸Ð¼Ð°Ð»ÑŒÐ½Ñ‹Ð¹ ÑƒÑ€Ð¾Ð²ÐµÐ½ÑŒ ÑÑ‚Ñ€Ð¾ÐµÐ½Ð¸Ñ",
            "settings_priorize_farm": "Priorize farm if it's full",
            "settings_saved": "ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ ÑÐ¾Ñ…Ñ€Ð°Ð½ÐµÐ½Ñ‹!",
            "logs_no_builds": "No builds started",
            "logs_clear": "ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ Ð¶ÑƒÑ€Ð½Ð°Ð» ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ð¹",
            "sequences": "ÐžÑ‡ÐµÑ€ÐµÐ´ÑŒ ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÐµÐ»ÑŒÑÑ‚Ð²Ð°",
            "sequences_move_up": "ÐŸÐ¾Ð´Ð½ÑÑ‚ÑŒ Ð²Ñ‹ÑˆÐµ",
            "sequences_move_down": "Ð¡Ð½ÐµÑÑ‚Ð¸",
            "sequences_add_building": "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÐµÐ»ÑŒÑÑ‚Ð²Ð¾",
            "sequences_select_edit": "Select a sequence to edit",
            "sequences_edit_sequence": "Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð¾Ñ‡ÐµÑ€ÐµÐ´ÑŒ",
            "select_group": "Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð³Ñ€ÑƒÐ¿Ð¿Ñƒ",
            "add_building_success": "%d has added at position %d",
            "add_building_limit_exceeded": "Ð´Ð¾ÑÑ‚Ð¸Ð³Ð½ÑƒÑ‚ Ð¼Ð°ÐºÑÐ¸Ð¼Ð°Ð»ÑŒÐ½Ñ‹Ð¹ ÑƒÑ€Ð¾Ð²ÐµÐ½ÑŒ",
            "position": "ÐŸÐ¾Ð·Ð¸Ñ†Ð¸Ñ",
            "remove_building": "Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ ÑÑ‚Ñ€Ð¾ÐµÐ½Ð¸Ðµ Ð¸Ð· ÑÐ¿Ð¸ÑÐºÐ°",
            "clone": "ÐšÐ»Ð¾Ð½Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ",
            "remove_sequence": "Remove selected sequence",
            "name_sequence_min_lenght": "The sequence name must have at least 3 character.",
            "sequence_created": "New sequence %d created.",
            "sequence_updated": "Sequence %d updated.",
        ...
        "builder_queue_add_building_modal": {
            "title": "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÐµÐ»ÑŒÑÑ‚Ð²Ð¾"
        },
        "builder_queue_name_sequence_modal": {
            "title": "Sequence name"
        },
        ...
        "command_queue": {
            "title": "ÐžÑ‡ÐµÑ€ÐµÐ´ÑŒ ÐºÐ¾Ð¼Ð°Ð½Ð´",
            "attack": "Ð°Ñ‚Ð°ÐºÐ°",
            "support": "Ð¿Ð¾Ð´Ð´ÐµÑ€Ð¶ÐºÐ°",
            "relocate": "Ð¿ÐµÑ€ÐµÐ¼ÐµÑ‰ÐµÐ½Ð¸Ðµ",
            "sent": "Ð¿Ð¾ÑÐ»Ð°Ñ‚ÑŒ",
            "activated": "Ð°ÐºÑ‚Ð¸Ð²Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ",
            "deactivated": "Ð¾Ñ‚ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¾",
            "expired": "Ð¸ÑÑ‚ÐµÐºÑ‰Ð¸Ð¹",
            "removed": "ÑƒÐ´Ð°Ð»ÐµÐ½Ð½Ñ‹Ð¹",
            "added": "Ð´Ð¾Ð±Ð°Ð²Ð»ÐµÐ½Ð¾",
            "general_clear": "Clear logs",
            "general_next_command": "Ð¡Ð»ÐµÐ´ÑƒÑŽÑ‰Ð°Ñ ÐºÐ¾Ð¼Ð°Ð½Ð´Ð°",
            "add_basics": "ÐŸÐ¾Ð´Ñ€Ð¾Ð±Ð½Ð¾ÑÑ‚Ð¸",
            "add_origin": "ÐšÐ¾Ð¾Ñ€Ð´Ð¸Ð½Ð°Ñ‚Ñ‹ Ñ‚Ð¾Ñ‡ÐºÐ¸ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¸Ñ",
            "add_selected": "Ð¢ÐµÐºÑƒÑ‰Ð°Ñ Ð´ÐµÑ€ÐµÐ²Ð½Ñ",
            "add_target": "ÐšÐ¾Ð¾Ñ€Ð´Ð¸Ð½Ð°Ñ‚Ñ‹ Ñ‚Ð¾Ñ‡ÐºÐ¸ Ð½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ",
            "add_map_selected": "Ð’Ñ‹Ð±Ñ€Ð°Ð½Ð½Ð°Ñ Ð´ÐµÑ€ÐµÐ²Ð½Ñ Ð½Ð° ÐºÐ°Ñ€Ñ‚Ðµ",
            "date_type_arrive": "Command arrive at date",
            "date_type_out": "Command leave at date",
            "add_current_date": "Ð¢ÐµÐºÑƒÑ‰Ð°Ñ Ð´Ð°Ñ‚Ð°",
            "add_current_date_plus": "Ð£Ð²ÐµÐ»Ð¸Ñ‡Ð¸Ñ‚ÑŒ Ð´Ð°Ñ‚Ñƒ Ð½Ð° 100 Ð¼Ð¸Ð»Ð»Ð¸ÑÐµÐºÑƒÐ½Ð´.",
            "add_current_date_minus": "Ð£Ð¼ÐµÐ½ÑŒÑˆÐ¸Ñ‚ÑŒ Ð´Ð°Ñ‚Ñƒ Ð½Ð° 100 Ð¼Ð¸Ð»Ð»Ð¸ÑÐµÐºÑƒÐ½Ð´.",
            "add_travel_times": "Ð’Ñ€ÐµÐ¼Ñ Ð² Ð¿ÑƒÑ‚Ð¸",
            "add_date": "Ð”Ð°Ñ‚Ð°/Ð²Ñ€ÐµÐ¼Ñ",
            "add_no_village": "Ð²Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð´ÐµÑ€ÐµÐ²Ð½ÑŽ...",
            "add_village_search": "ÐŸÐ¾Ð¸ÑÐº Ð´ÐµÑ€ÐµÐ²Ð½Ð¸...",
            "add_clear": "ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ Ð¿Ð¾Ð»Ñ",
            "add_insert_preset": "Ð’ÑÑ‚Ð°Ð²Ð¸Ñ‚ÑŒ ÑˆÐ°Ð±Ð»Ð¾Ð½",
            "queue_waiting": "ÐžÐ¶Ð¸Ð´Ð°Ð½Ð¸Ðµ ÐºÐ¾Ð¼Ð°Ð½Ð´",
            "queue_none_added": "ÐÐµÑ‚ Ð´Ð¾Ð±Ð°Ð²Ð»ÐµÐ½Ð½Ñ‹Ñ… ÐºÐ¾Ð¼Ð°Ð½Ð´.",
            "queue_sent": "ÐžÑ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð½Ñ‹Ðµ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñ‹",
            "queue_none_sent": "ÐÐµÑ‚ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð½Ñ‹Ñ… ÐºÐ¾Ð¼Ð°Ð½Ð´.",
            "queue_expired": "ÐŸÑ€Ð¾ÑÑ€Ð¾Ñ‡ÐµÐ½Ð½Ñ‹Ðµ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñ‹",
            "queue_none_expired": "ÐÐµÑ‚ Ð·Ð°Ð²ÐµÑ€ÑˆÐµÐ½Ð½Ñ‹Ñ… ÐºÐ¾Ð¼Ð°Ð½Ð´.",
            "queue_remove": "Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñƒ Ð¸Ð· ÑÐ¿Ð¸ÑÐºÐ°",
            "queue_filters": "Ð¤Ð¸Ð»ÑŒÑ‚Ñ€ ÐºÐ¾Ð¼Ð°Ð½Ð´",
            "filters_selected_village": "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñ‹ Ð¸Ð· Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ð¾Ð¹ Ð´ÐµÑ€ÐµÐ²Ð½Ð¸",
            "filters_barbarian_target": "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñ‹ Ñ Ð´ÐµÑ€ÐµÐ²Ð½ÑÐ¼Ð¸ Ð²Ð°Ñ€Ð²Ð°Ñ€Ð¾Ð² Ð² ÐºÐ°Ñ‡ÐµÑÑ‚Ð²Ðµ Ñ†ÐµÐ»Ð¸",
            "filters_attack": "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð°Ñ‚Ð°ÐºÐ¸",
            "filters_support": "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð¿Ð¾Ð´ÐºÑ€ÐµÐ¿Ð»ÐµÐ½Ð¸Ñ",
            "filters_relocate": "ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð¿ÐµÑ€ÐµÐ¼ÐµÑ‰ÐµÐ½Ð¸Ñ",
            "filters_text_match": "Ð¤Ð¸Ð»ÑŒÑ‚Ñ€ Ð¿Ð¾ Ñ‚ÐµÐºÑÑ‚Ñƒ...",
            "command_out": "Ð’Ñ‹Ñ…Ð¾Ð´",
            "command_time_left": "Ð’Ñ€ÐµÐ¼ÐµÐ½Ð¸ Ð¾ÑÑ‚Ð°Ð»Ð¾ÑÑŒ",
            "command_arrive": "ÐŸÑ€Ð¸Ð±Ñ‹Ñ‚Ð¸Ðµ",
            "error_no_units_enough": "No units enough to send the command!",
            "error_not_own_village": "Ð”ÐµÑ€ÐµÐ²Ð½Ñ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¸Ñ Ð¿Ñ€Ð¸Ð½Ð°Ð´Ð»ÐµÐ¶Ð¸Ñ‚ Ð½Ðµ Ð’Ð°Ð¼!",
            "error_origin": "ÐšÐ¾Ð¾Ñ€Ð´Ð¸Ð½Ð°Ñ‚Ñ‹ Ð´ÐµÑ€ÐµÐ²Ð½Ð¸ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¸Ñ Ð½ÐµÐ²ÐµÑ€Ð½Ñ‹!",
            "error_target": "ÐšÐ¾Ð¾Ñ€Ð´Ð¸Ð½Ð°Ñ‚Ñ‹ Ð´ÐµÑ€ÐµÐ²Ð½Ð¸ Ð½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ Ð½ÐµÐ²ÐµÑ€Ð½Ñ‹!",
            "error_no_units": "ÐÐµ ÑƒÐºÐ°Ð·Ð°Ð½Ñ‹ Ð²Ð¾Ð¹ÑÐºÐ°!",
            "error_invalid_date": "ÐÐµÐ²ÐµÑ€Ð½Ð°Ñ Ð´Ð°Ñ‚Ð°",
            "error_already_sent_attack": "This attack should have already left",
            "error_already_sent_support": "This support should have already left",
            "error_already_sent_relocate": "This relocate should have already left",
            "error_relocate_disabled": "Relocate is not enabled in this world.",
            "error_no_map_selected_village": "ÐÐµÑ‚ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ð¾Ð¹ Ð´ÐµÑ€ÐµÐ²Ð½Ð¸ Ð½Ð° ÐºÐ°Ñ€Ñ‚Ðµ.",
            "error_remove_error": "ÐžÑˆÐ¸Ð±ÐºÐ° ÑƒÐ´Ð°Ð»ÐµÐ½Ð¸Ñ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñ‹.",
            "tab_add": "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ ÐºÐ¾Ð¼Ð°Ð½Ð´Ñƒ",
            "tab_waiting": "ÐšÐ¾Ð¼Ð°Ð½Ð´Ñ‹ Ð² Ð¾Ñ‡ÐµÑ€ÐµÐ´Ð¸",
            "tab_logs": "Ð–ÑƒÑ€Ð½Ð°Ð» ÐºÐ¾Ð¼Ð°Ð½Ð´"
        },
        "farm_overflow": {
            "open_report": "ÐžÑ‚ÐºÑ€Ñ‹Ñ‚ÑŒ Ð¾Ñ‚Ñ‡ÐµÑ‚",
            "no_report": "ÐÐµÑ‚ Ð¾Ñ‚Ñ‡ÐµÑ‚Ð°",
            "reports": "ÐžÑ‚Ñ‡Ñ‘Ñ‚Ñ‹",
            "date": "Ð”Ð°Ñ‚Ð°",
            "status_time_limit": "Ð¦ÐµÐ»ÑŒ ÑÐ»Ð¸ÑˆÐºÐ¾Ð¼ Ð´Ð°Ð»ÐµÐºÐ¾",
            "status_command_limit": "ÐŸÑ€ÐµÐ´ÐµÐ» ÐºÐ¾Ð»Ð¸Ñ‡ÐµÑÑ‚Ð²Ð° ÐºÐ¾Ð¼Ð°Ð½Ð´",
            "status_full_storage": "Ð¡ÐºÐ»Ð°Ð´ Ð¿ÐµÑ€ÐµÐ¿Ð¾Ð»Ð½ÐµÐ½",
            "status_no_units": "ÐÐµÑ‚ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ñ‹Ñ… Ð²Ð¾Ð¹ÑÐº",
            "status_abandoned_conquered": "ÐŸÐ¾Ð±ÐµÐ´Ð° Ð´ÐµÑ€ÐµÐ²Ð½Ð¸ Ð²Ð°Ñ€Ð²Ð°Ñ€Ð¾Ð²",
            "status_protected_village": "Ð¦ÐµÐ»ÑŒ Ð¿Ð¾Ð´ Ð·Ð°Ñ‰Ð¸Ñ‚Ð¾Ð¹",
            "status_busy_target": "Ð¦ÐµÐ»ÑŒ Ð¿Ð¾Ð´ Ð°Ñ‚Ð°ÐºÐ¾Ð¹",
            "status_no_targets": "ÐÐµÑ‚ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ñ‹Ñ… Ñ†ÐµÐ»ÐµÐ¹",
            "status_target_cycle_end": "ÐŸÐµÑ€ÐµÑ‡ÐµÐ½ÑŒ Ñ†ÐµÐ»ÐµÐ¹ Ð·Ð°ÐºÐ¾Ð½Ñ‡ÐµÐ½",
            "status_not_allowed_points": "Ð—Ð°Ð¿Ñ€ÐµÑ‰ÐµÐ½Ð½Ñ‹Ðµ Ñ†ÐµÐ»Ð¸ Ð½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ",
            "status_unknown": "ÐÐµÐ¸Ð·Ð²ÐµÑÑ‚Ð½Ñ‹Ð¹ ÑÑ‚Ð°Ñ‚ÑƒÑ",
            "status_attacking": "ÐÑ‚Ð°ÐºÐ¾Ð²Ð°Ð½Ð¾",
            "status_waiting_cycle": "ÐžÐ¶Ð¸Ð´Ð°Ð½Ð¸Ðµ",
            "status_user_stop": "Stopped by player",
            "status_expired_step": "Expired command",
            "not_loaded": "ÐÐµ Ð·Ð°Ð³Ñ€ÑƒÐ¶ÐµÐ½Ð¾.",
            "ignored_targets": "Ð˜Ð³Ð½Ð¾Ñ€Ð¸Ñ€ÑƒÐµÐ¼Ñ‹Ðµ Ñ†ÐµÐ»Ð¸",
            "no_ignored_targets": "ÐÐ¸Ñ‡ÐµÐ³Ð¾ Ð½Ðµ Ð¸Ð³Ð½Ð¾Ñ€Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ",
            "included_targets": "Ð’ÐºÐ»ÑŽÑ‡ÐµÐ½Ð½Ñ‹Ðµ Ñ†ÐµÐ»Ð¸",
            "no_included_targets": "ÐÐµÑ‚ Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ð½Ñ‹Ñ…",
            "farmer_villages": "Ð“Ñ€Ð°Ð±ÐµÐ¶ Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ",
            "no_farmer_villages": "ÐÐµÑ‚ Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ Ð´Ð»Ñ Ð³Ñ€Ð°Ð±ÐµÐ¶Ð°",
            "last_status": "ÐŸÐ¾ÑÐ»ÐµÐ´Ð½Ð¸Ð¹ ÑÑ‚Ð°Ñ‚ÑƒÑ",
            "attacking": "ÐÑ‚Ð°ÐºÐ¾Ð²Ð°Ð½Ð¾.",
            "paused": "ÐŸÑ€Ð¸Ð¾ÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½.",
            "command_limit": "Ð”Ð¾ÑÑ‚Ð¸Ð³Ð½ÑƒÑ‚ Ð»Ð¸Ð¼Ð¸Ñ‚ Ð² 50 Ð°Ñ‚Ð°Ðº, Ð´Ð¾Ð¶Ð´Ð¸Ñ‚ÐµÑÑŒ Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‰ÐµÐ½Ð¸Ñ.",
            "last_attack": "ÐŸÐ¾ÑÐ»ÐµÐ´Ð½ÑÑ Ð°Ñ‚Ð°ÐºÐ°",
            "village_switch": "ÐŸÐµÑ€ÐµÑ…Ð¾Ð´ Ðº Ð´ÐµÑ€ÐµÐ²Ð½Ð¸",
            "no_preset": "ÐÐµÑ‚ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ñ‹Ñ… ÑˆÐ°Ð±Ð»Ð¾Ð½Ð¾Ð².",
            "no_selected_village": "ÐÐµÑ‚ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ñ‹Ñ… Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ.",
            "no_units": "ÐÐµÑ‚ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ñ‹Ñ… Ð²Ð¾Ð¹ÑÐº Ð² Ð´ÐµÑ€ÐµÐ²Ð½Ð¸, Ð´Ð¾Ð¶Ð´Ð¸Ñ‚ÐµÑÑŒ Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‰ÐµÐ½Ð¸Ñ.",
            "no_units_no_commands": "ÐÐ¸ Ð² Ð¾Ð´Ð½Ð¾Ð¹ Ð¸Ð· Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ Ð½ÐµÑ‚ Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‰Ð°ÑŽÑ‰Ð¸Ñ…ÑÑ Ð²Ð¾Ð¹ÑÐº.",
            "no_villages": "ÐÐµÑ‚ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ñ‹Ñ… Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ, Ð´Ð¾Ð¶Ð´Ð¸Ñ‚ÐµÑÑŒ Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‰ÐµÐ½Ð¸Ñ Ð²Ð¾Ð¹ÑÐº.",
            "preset_first": "Ð£ÑÑ‚Ð°Ð½Ð¾Ð²Ð¸Ñ‚Ðµ Ð²Ð½Ð°Ñ‡Ð°Ð»Ðµ ÑˆÐ°Ð±Ð»Ð¾Ð½!",
            "selected_village": "Ð’Ñ‹Ð±Ñ€Ð°Ð½Ð½Ð°Ñ Ð´ÐµÑ€ÐµÐ²Ð½Ñ",
            "loading_targets": "Ð—Ð°Ð³Ñ€ÑƒÐ·ÐºÐ° Ñ†ÐµÐ»ÐµÐ¹...",
            "checking_targets": "ÐŸÑ€Ð¾Ð²ÐµÑ€ÐºÐ° Ñ†ÐµÐ»ÐµÐ¹...",
            "restarting_commands": "ÐŸÐµÑ€ÐµÐ·Ð°Ð¿ÑƒÑÐº ÐºÐ¾Ð¼Ð°Ð½Ð´...",
            "ignored_village": "Ð´Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ð² Ð¸Ð³Ð½Ð¾Ñ€Ð¸Ñ€ÑƒÐµÐ¼Ð¾Ðµ",
            "included_village": "Ð´Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ð²Ð¾ Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ð½Ð¾Ðµ",
            "ignored_village_removed": "ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ Ð¸Ð· Ð¸Ð³Ð½Ð¾Ñ€Ð¸Ñ€ÑƒÐµÐ¼Ð¾Ð³Ð¾",
            "included_village_removed": "ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ Ð¸Ð· Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ð½Ð¾Ð³Ð¾",
            "priority_target": "Ð´Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ð² Ð¿Ñ€Ð¸Ð¾Ñ€Ð¸Ñ‚ÐµÑ‚Ð½Ð¾Ðµ.",
            "analyse_targets": "ÐÐ½Ð°Ð»Ð¸Ð· Ñ†ÐµÐ»ÐµÐ¹.",
            "step_cycle_restart": "ÐŸÐµÑ€ÐµÐ·Ð°Ð¿ÑƒÑÐº Ñ†Ð¸ÐºÐ»Ð° ÐºÐ¾Ð¼Ð°Ð½Ð´..",
            "step_cycle_end": "ÐŸÐµÑ€ÐµÑ‡ÐµÐ½ÑŒ Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ Ð¾ÐºÐ¾Ð½Ñ‡ÐµÐ½, Ð´Ð¾Ð¶Ð´Ð¸Ñ‚ÐµÑÑŒ ÑÐ»ÐµÐ´ÑƒÑŽÑ‰ÐµÐ³Ð¾ ÐºÑ€ÑƒÐ³Ð°.",
            "step_cycle_end_no_villages": "ÐÐµÑ‚ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ñ‹Ñ… Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ Ð´Ð»Ñ ÑÑ‚Ð°Ñ€Ñ‚Ð° Ñ†Ð¸ÐºÐ»Ð°.",
            "step_cycle_next": "ÐŸÐµÑ€ÐµÑ‡ÐµÐ½ÑŒ Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ Ð·Ð°ÐºÐ¾Ð½Ñ‡Ð¸Ð»ÑÑ, ÑÐ»ÐµÐ´ÑƒÑŽÑ‰Ð¸Ð¹ Ñ†Ð¸ÐºÐ»: %d.",
            "step_cycle_next_no_villages": "ÐÐµÑ‚Ñƒ ÑÐ²Ð¾Ð±Ð¾Ð´Ð½Ñ‹Ñ… Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ Ð´Ð»Ñ Ð½Ð°Ñ‡Ð°Ð»Ð° Ñ†Ñ‹ÐºÐ»Ð°, ÑÐ»ÐµÐ´ÑƒÑŽÑ‰Ð¸Ð¹ Ñ†Ñ‹ÐºÐ».",
            "full_storage": "Ð¡ÐºÐ»Ð°Ð´ Ð´ÐµÑ€ÐµÐ²Ð½Ð¸ Ð·Ð°Ð¿Ð¾Ð»Ð½ÐµÐ½.",
            "farm_stopped": "ÐŸÐµÑ€ÐµÐ¸Ð·Ð±Ñ‹Ñ‚Ð¾Ðº Ð¤Ð°Ñ€Ð¼Ð° Ð¾ÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½.",
            "farm_started": "ÐŸÐµÑ€ÐµÐ¸Ð·Ð±Ñ‹Ñ‚Ð¾Ðº Ð¤Ð°Ñ€Ð¼Ð° Ð½Ð°Ñ‡Ð°Ñ‚.",
            "groups_presets": "Ð“Ñ€ÑƒÐ¿Ð¿Ñ‹ Ð¸ Ð¨Ð°Ð±Ð»Ð¾Ð½Ñ‹",
            "presets": "ÐÑ‚Ð°ÐºÐ° Ñ ÑˆÐ°Ð±Ð»Ð¾Ð½Ð°Ð¼Ð¸",
            "group_ignored": "Ð˜Ð³Ð½Ð¾Ñ€Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð´ÐµÑ€ÐµÐ²Ð½Ð¸ Ð¸Ð· Ð³Ñ€ÑƒÐ¿Ð¿Ñ‹",
            "group_include": "Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð´ÐµÑ€ÐµÐ²Ð½Ð¸ Ð¸Ð· Ð³Ñ€ÑƒÐ¿Ð¿",
            "group_only": "ÐÑ‚Ð°ÐºÐ¾Ð²Ð°Ñ‚ÑŒ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ñ Ð´ÐµÑ€ÐµÐ²Ð½ÑÐ¼Ð¸ Ð¸Ð· Ð³Ñ€ÑƒÐ¿Ð¿",
            "attack_interval": "Ð˜Ð½Ñ‚ÐµÑ€Ð²Ð°Ð»Ñ‹ Ð¼ÐµÐ¶Ð´Ñƒ Ð°Ñ‚Ð°ÐºÐ°Ð¼Ð¸",
            "preserve_command_slots": "Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ ÑƒÐ¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¸Ðµ ÑÐ»Ð¾Ñ‚Ð°Ð¼Ð¸",
            "target_single_attack": "Ð Ð°Ð·Ñ€ÐµÑˆÐ¸Ñ‚ÑŒ Ñ†ÐµÐ»ÑÐ¼ Ð¿Ñ€Ð¸Ð½Ð¸Ð¼Ð°Ñ‚ÑŒ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ð¾Ð´Ð½Ñƒ Ð°Ñ‚Ð°ÐºÑƒ Ð½Ð° Ð´ÐµÑ€ÐµÐ²Ð½ÑŽ",
            "target_multiple_farmers": "Ð Ð°Ð·Ñ€ÐµÑˆÐ¸Ñ‚ÑŒ Ñ†ÐµÐ»ÑÐ¼ Ð¿Ð¾Ð»ÑƒÑ‡Ð°Ñ‚ÑŒ Ð¼Ð½Ð¾Ð¶ÐµÑÑ‚Ð²Ð¾ Ð°Ñ‚Ð°Ðº Ñ Ñ€Ð°Ð·Ð½Ñ‹Ñ… Ð´ÐµÑ€ÐµÐ²ÐµÐ½ÑŒ",
            "farmer_cycle_interval": "Ð˜Ð½Ñ‚ÐµÑ€Ð²Ð°Ð»Ð¸ Ð¼ÐµÐ¶Ð´Ñƒ Ñ„Ð°Ñ€Ð¼ Ñ†Ñ‹ÐºÐ»Ð°Ð¼Ð¸ (Ð¼Ð¸Ð½ÑƒÑ‚Ñ‹)",
            "ignore_on_loss": "Ð˜Ð³Ð½Ð¾Ñ€Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð´ÐµÑ€ÐµÐ²Ð½Ð¸, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ðµ Ð¿Ñ€Ð¸Ð½Ð¾ÑÑÑ‚ Ð¿Ð¾Ñ‚ÐµÑ€Ð¸",
            "ignore_full_storage": "Do not farm with villages with full storage",
            "step_cycle_header": "Step Cycle Settings",
            "step_cycle": "Enable Step Cycle",
            "step_cycle_notifs": "Ð¦Ñ‹ÐºÐ» ÑƒÐ²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ð¹",
            "target_filters": "Ð¦ÐµÐ»ÐµÐ²Ñ‹Ðµ Ñ„Ð¸Ð»ÑŒÑ‚Ñ€Ñ‹",
            "min_distance": "ÐœÐ¸Ð½Ð¸Ð¼Ð°Ð»ÑŒÐ½Ð¾Ðµ Ñ€Ð°ÑÑÑ‚Ð¾ÑÐ½Ð¸Ðµ Ð´Ð¾ Ñ†ÐµÐ»Ð¸",
            "max_distance": "ÐœÐ°ÐºÑÐ¸Ð¼Ð°Ð»ÑŒÐ½Ð¾Ðµ Ñ€Ð°ÑÑÑ‚Ð¾ÑÐ½Ð¸Ðµ Ð´Ð¾ Ñ†ÐµÐ»Ð¸",
            "min_points": "ÐœÐ¸Ð½Ð¸Ð¼Ð°Ð»ÑŒÐ½Ñ‹Ðµ Ð¾Ñ‡ÐºÐ¸ Ñ†ÐµÐ»Ð¸",
            "max_points": "ÐœÐ°ÐºÑÐ¸Ð¼Ð°Ð»ÑŒÐ½Ñ‹Ðµ Ð¾Ñ‡ÐºÐ¸ Ñ†ÐµÐ»Ð¸",
            "max_travel_time": "ÐœÐ°ÐºÑÐ¸Ð¼Ð°Ð»ÑŒÐ½Ð¾Ðµ Ð²Ñ€ÐµÐ¼Ñ Ð¿ÐµÑ€ÐµÐ´Ð²Ð¸Ð¶ÐµÐ½Ð¸Ñ (Ð¼Ð¸Ð½ÑƒÑ‚Ñ‹)",
            "logs_limit": "ÐœÐ°ÐºÑÐ¸Ð¼Ð°Ð»ÑŒÐ½Ð¾Ðµ ÐºÐ¾Ð»Ð»Ð¸Ñ‡ÐµÑÑ‚Ð²Ð¾ Ð·Ð°Ð¿Ð¸ÑÐµÐ¹ Ð² Ð¶ÑƒÑ€Ð½Ð°Ð»Ðµ ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ð¹",
            "event_attack": "Show task logs of attacks",
            "event_village_change": "Show task logs of village's changes",
            "event_priority_add": "Show task logs of priority targets",
            "event_ignored_village": "Show task logs of ignored villages",
            "settings_saved": "ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ ÑÐ¾Ñ…Ñ€Ð°Ð½ÐµÐ½Ñ‹!",
            "misc": "Ð Ð°Ð·Ð½Ð¾Ð¾Ð±Ñ€Ð°Ð·Ð½Ñ‹Ð¹",
            "attack": "ÐÑ‚Ð°ÐºÐ°",
            "no_logs": "ÐÐµÑ‚Ñƒ Ð·Ð°Ñ€ÐµÐ³Ð¸ÑÑ‚Ñ€Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð½Ð¾Ð³Ð¾ Ð¶ÑƒÑ€Ð°Ð½Ð°Ð» ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ð¹",
            "clear_logs": "ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ Ð¶ÑƒÑ€Ð½Ð°Ð» ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ñ",
            "reseted_logs": "Ð—Ð°Ñ€ÐµÐ³Ð¸ÑÑ‚Ñ€Ð¾Ð²Ð°Ð½Ð½Ñ‹Ð¹ Ð¶ÑƒÑ€Ð½Ð°Ð» ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ð¹ Ð¾Ð±Ð½ÑƒÐ»Ñ‘Ð½.",
            "date_added": "Ð”Ð°Ð½Ð½Ñ‹Ðµ Ð´Ð¾Ð±Ð°Ð²Ð»ÐµÐ½Ñ‹",
            "multiple_attacks_interval": "Interval between attacks in the same target (minutes)",
            "next_cycle_in": "Next cycle starts in",
            "target_limit_per_village": "Limit of targets per village"
        },
        "minimap": {
            "minimap": "ÐœÐ¸Ð½Ð¸ÐºÐ°Ñ€Ñ‚Ð°",
            "highlights": "Highlights",
            "add": "Add highlight",
            "remove": "Remove highlight",
            "very_small": "Very small",
        ...
        "common": {
            "start": "ÐÐ°Ñ‡Ð°Ñ‚ÑŒ",
            "started": "Ð—Ð°Ð¿ÑƒÑ‰ÐµÐ½",
            "pause": "ÐŸÐ°ÑƒÐ·Ð°",
            "paused": "ÐŸÑ€Ð¸Ð¾ÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½",
            "stop": "Ð¡Ñ‚Ð¾Ð¿",
            "stopped": "ÐžÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½",
            "status": "Ð¡Ñ‚Ð°Ñ‚ÑƒÑ",
            "none": "ÐžÑ‚ÑÑƒÑ‚ÑÐ²ÑƒÐµÑ‚",
            "info": "Ð˜Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ",
            "settings": "ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸",
            "others": "ÐŸÑ€Ð¾Ñ‡ÐµÐµ",
            "village": "Ð”ÐµÑ€ÐµÐ²Ð½Ñ",
            "villages": "Ð”ÐµÑ€ÐµÐ²Ð½Ð¸",
            "building": "Ð¡Ñ‚Ñ€Ð¾ÐµÐ½Ð¸Ðµ",
            "buildings": "Ð¡Ñ‚Ñ€Ð¾ÐµÐ½Ð¸Ñ",
            "level": "Ð£Ñ€Ð¾Ð²ÐµÐ½ÑŒ",
            "registers": "Ð–ÑƒÑ€Ð½Ð°Ð» ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ð¹",
            "filters": "Ð¤Ð¸Ð»ÑŒÑ‚Ñ€Ñ‹",
            "add": "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ",
            "waiting": "ÐžÐ¶Ð¸Ð´Ð°Ð½Ð¸Ðµ",
            "attack": "ÐÑ‚Ð°ÐºÐ°",
            "support": "ÐŸÐ¾Ð´Ð´ÐµÑ€Ð¶ÐºÐ°",
            "relocate": "ÐŸÐµÑ€ÐµÐ¼ÐµÑ‰ÐµÐ½Ð¸Ðµ",
            "activate": "ÐÐºÑ‚Ð¸Ð²Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ",
            "deactivate": "ÐžÑ‚ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ",
            "units": "Ð’Ð¾Ð¹ÑÐºÐ°",
            "officers": "Ð’Ð¾ÐµÐ½Ð°Ñ‡Ð°Ð»ÑŒÐ½Ð¸ÐºÐ¸",
            "origin": "Ð¢Ð¾Ñ‡ÐºÐ° Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¸Ñ",
            "target": [
                "Ð¢Ð¾Ñ‡ÐºÐ° Ð½Ð°Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ",
                "Ð¦ÐµÐ»Ð¸"
            ],
            "save": "Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ",
            "logs": "Ð–ÑƒÑ€Ð½Ð°Ð» ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ð¹",
            "no-results": "No results...",
            "selected": "Selected",
            "now": "Now",
            "costs": "Costs",
...
define('two/autoCollector', [
    ...
    /**
     * ForÃ§a a atualizaÃ§Ã£o das informaÃ§Ãµes do depÃ³sito.
     */
    ...
    /**
     * Faz a analise dos trabalhos sempre que um evento relacionado ao depÃ³sito
     * Ã© disparado.
     */
    ...
    /**
     * Obtem o trabalho de menor duraÃ§Ã£o.
     *
    ...
    /**
     * Atualiza o timeout para que seja forÃ§ado a atualizaÃ§Ã£o das informaÃ§Ãµes
     * do depÃ³sito quando for resetado.
     * Motivo: sÃ³ Ã© chamado automaticamente quando um milestone Ã© resetado,
     * e nÃ£o o diÃ¡rio.
     * 
    ...
    /**
     * MÃ©todos pÃºblicos do AutoCollector.
     *
     * @type {Object}
     */
    let autoCollector = {}
    ...
    /**
     * Retorna se o modulo estÃ¡ em funcionamento.
     */
    ...
    /**
     * Retorna se o modulo estÃ¡ inicializado.
     */
...
define('two/commandQueue/ui', [
    ...
    /**
     * Gera um texto de notificaÃ§Ã£o com as traduÃ§Ãµes.
     *
     * @param  {String} key
     * @param  {String} key2
     * @param  {String=} prefix
